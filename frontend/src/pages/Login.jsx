  ...
  return (
    <main className="min-h-screen bg-earth-50 flex items-center justify-center p-4">
      <form onSubmit={submit} className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl border border-earth-200">
        ...
        {error && (
          <p className="mb-4 flex gap-2 rounded-lg bg-red-50 p-3 text-sm text-red-700">
        ...
        <input
          ...
          required
          className="mb-4 w-full rounded-xl border border-earth-300 px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-zim-500"
        />
        ...
        <input
          ...
          required
          className="mb-6 w-full rounded-xl border border-earth-300 px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-zim-500"
        />
        ...
        <div className="mt-4 flex justify-between text-sm">
          <Link className="text-zim-700 underline" to="/register">Create ranger account</Link>
          <Link className="text-zim-700 underline" to="/reset-password">Forgot password?</Link>
        </div>
